  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="公寓名称" prop="gongyumingcheng">
              <el-input v-model="ruleForm.gongyumingcheng" 
                placeholder="公寓名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="公寓户型" prop="gongyuhuxing">
          <el-select v-model="ruleForm.gongyuhuxing" placeholder="请选择公寓户型">
            <el-option
                v-for="(item,index) in gongyuhuxingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="公寓户型" prop="gongyuhuxing">
	      <el-input v-model="ruleForm.gongyuhuxing"
                placeholder="公寓户型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公寓设施" prop="gongyusheshi">
          <el-input v-model="ruleForm.gongyusheshi" 
              placeholder="公寓设施" clearable  :readonly="ro.gongyusheshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公寓设施" prop="gongyusheshi">
              <el-input v-model="ruleForm.gongyusheshi" 
                placeholder="公寓设施" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongyumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='gongyuhuxing'){
            this.ruleForm.gongyuhuxing = obj[o];
	    this.ro.gongyuhuxing = true;
            continue;
          }
	            	            if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='gongyusheshi'){
            this.ruleForm.gongyusheshi = obj[o];
	    this.ro.gongyusheshi = true;
            continue;
          }
	            	            if(o=='weizhi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.$http({
              url: `option/gongyuhuxing/huxing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.gongyuhuxingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.gongyuxiangqing = this.ruleForm.gongyuxiangqing.replace(reg,'../../../ssmon1z9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
